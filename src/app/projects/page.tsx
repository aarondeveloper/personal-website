                    ...
                    <div>
                      ...
                      {project.award && (
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          <span className="text-yellow-400">{project.award.title}</span>
                          <span className="text-gray-400">•</span>
                          <span className="text-gray-300">{project.award.event}</span>
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex gap-4">
                  {project.links.map((link) => (
                    <a
                      ...
                      className="flex items-center gap-2 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 px-4 py-2 rounded-lg transition-all duration-200 hover:scale-105"
                    >
                      {link.icon}
                      {link.name}
                    </a>
