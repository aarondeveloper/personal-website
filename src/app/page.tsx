        ...
        <div className="hidden md:flex justify-center mb-6">
          <div className="w-full" style={{ maxWidth: 'calc(500px + 350px + 500px + 2rem)' }}>
            <Link 
              ...
              className="bg-black/40 backdrop-blur-sm rounded-xl p-4 flex items-center hover:bg-black/50 transition-all duration-200 hover:scale-[1.01] hover:shadow-emerald-500/20 hover:shadow-lg group w-full"
            >
